...
module.exports = {
    ...
    output: {
        ...
        publicPath: 'https://fitogram-calendar-alpha.azurewebsites.net/',
        library: 'Widgets',
        libraryTarget: 'umd',
                    ...
                    replacements: [
                        {
                            pattern: /@apiURL/ig,
                            replacement() {
                                return 'https://fitogram-webapi-alpha.azurewebsites.net';
                            }
                        },
                        {
                            pattern: /@shopURL/ig,
                            replacement() {
                                return 'https://fitogram-shop-alpha.azurewebsites.net';
                            }
                        },
                        {
                            pattern: /@facebookAppID/ig,
                            replacement() {
                                return '755038041207990';
                            }
                        }
                    ]}), 'babel'],
            },
